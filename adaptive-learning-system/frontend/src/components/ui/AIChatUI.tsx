...
import { Sparkles, X, Send, AlertTriangle, Bot, Trash2 } from 'lucide-react';
...
/**
 * Reusable React presentation component that renders the A I Chat U I user interface element.
 */
interface Props {
  moduleId: string;
  moduleTitle: string;
...
export const AIChatUI: React.FC<Props> = ({
  ...
  const prevModuleIdRef = React.useRef(moduleId);
  useEffect(() => {
