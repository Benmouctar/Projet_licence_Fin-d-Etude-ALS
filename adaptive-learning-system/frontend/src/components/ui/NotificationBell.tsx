...
/**
 * Reusable React presentation component that renders the Notification Bell user interface element.
 */
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute left-full bottom-0 ml-3 w-80 z-[60] rounded-2xl border border-white/30 dark:border-white/10 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl shadow-2xl shadow-slate-300/40 dark:shadow-black/40 overflow-hidden flex flex-col"
            style={{ maxHeight: 'min(480px, calc(100vh - 2rem))' }}
          >
            {}
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        notification.readStatus && 'opacity-50',
      )}
    >
      {}
