...
/**
 * Reusable React presentation component that renders the Sidebar user interface element.
 */
  ...
  return (
    <aside
      className={cn(
        ...
        'fixed lg:static inset-y-0 left-0 w-[260px] z-50 p-4 sm:p-6',
    ...
    >
      <GlassContainer className="h-full flex flex-col p-5 bg-white/80 dark:bg-slate-900/80">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-lg font-extrabold tracking-tight text-slate-900 dark:text-white leading-none">Co-Learn</h1>
            ...
            {navItems.map(item => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "w-full flex items-center gap-3 px-4 py-3 rounded-xl font-semibold text-sm transition-all relative text-left",
                    active
