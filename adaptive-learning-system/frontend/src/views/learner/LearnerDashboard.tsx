...
import {
  ...
  CheckCircle, AlertTriangle, Compass, Sparkles, Trash2,
} from 'lucide-react';
...
/**
 * React view component representing the user interface dashboard or page for Learner Dashboard.
 */
                ...
                >
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <div className="shrink-0 flex flex-col items-center gap-2">
                      ...
                      {}
                      {mastery !== 'MASTERED' && (
                        unenrollingId === enrollment.courseId ? (
                          ...
                          >
                            <button
                              onClick={e => {
                                e.stopPropagation();
                                unenroll(enrollment.courseId, {
                                  onSettled: () => setUnenrollingId(null),
                                });
                              }}
                              disabled={unenrolling}
                              className="text-[10px] font-bold px-2 py-1 rounded-lg bg-red-500 hover:bg-red-600 text-white transition-colors"
                            >
                              Confirm
                            </button>
                            <button
                              onClick={e => { e.stopPropagation(); setUnenrollingId(null); }}
                              className="text-[10px] font-semibold px-2 py-1 rounded-lg text-slate-500 hover:text-slate-700 hover:bg-slate-100 dark:hover:bg-white/10 transition-colors"
                            >
                              Cancel
                            </button>
                          </div>
                          ...
                          <button
                            ...
                            onClick={e => { e.stopPropagation(); setUnenrollingId(enrollment.courseId); }}
