...
/**
 * REST controller exposing API endpoints for managing and retrieving Enrollment data.
 */
@Slf4j
@RestController
...
public class EnrollmentController {
    ...
    public ResponseEntity<?> unenroll(@PathVariable String courseId) {
        String email = SecurityContextHolder.getContext().getAuthentication().getName();
        try {
            enrollmentService.unenroll(courseId, email);
