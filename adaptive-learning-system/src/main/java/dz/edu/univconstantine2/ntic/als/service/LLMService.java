...
/**
 * Service class containing business logic, validation rules, and transactional processing for L L M.
 */
@Service
public class LLMService {
    ...
    private String buildSystemPrompt(String courseName, String moduleTitle, List<String> contextChunks) {
        if (contextChunks.isEmpty()) {
            return "You are an AI Tutor for the course '" + courseName + "', specifically for the module '"
                    + moduleTitle + "'. " +
        ...
        prompt.append("Your goal is to help the student understand the following module: '").append(moduleTitle)
                .append("'.\n\n");
        ...
        prompt.append(
                "2. Adopt a Socratic approach: avoid giving direct answers immediately if the concept is complex. Instead, guide the student with hints or clarifying questions.\n");
